...
cam = cv2.VideoCapture("ytvideo.mp4")
## videocapture(0) default kamera
##  1 yazarsanız usb kamera
## url yazıp   url = http:// doldurursanız ip kamera geçer
